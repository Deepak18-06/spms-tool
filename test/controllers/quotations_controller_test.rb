...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference("Quotation.count") do
      post quotations_url, params: { quotation: { attachment: @quotation.attachment, comment: @quotation.comment, customer_id: @quotation.customer_id, date: @quotation.date } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { attachment: @quotation.attachment, comment: @quotation.comment, customer_id: @quotation.customer_id, date: @quotation.date } }
